...
lfp_tfa_cfg.results_folder = fullfile('D:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir', 'TDT', 'lfp_tfa', 'RESULTS', 'LFP_TFA');
...
lfp_tfa_cfg.info_filepath = fullfile('D:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir',...
...
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile('D:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir',...
...
lfp_tfa_cfg.compare.targets = {'PMd_r'};
...
if any(strcmp(lfp_tfa_cfg.analyses, 'sync') | strcmp(lfp_tfa_cfg.analyses, 'syncsp'))
	...
	%        {'MIP_L', 'MIP_L'}};
	lfp_tfa_cfg.compare.target_pairs = {{'PMd_r', 'PMd_r'}};
end
...
lfp_tfa_cfg.analyse_epochs = {...
	...
	lfp_tfa_states.SCP_A_GoSignalTime_ms,				'aGOon',	-1.5,	1.5; ...
	lfp_tfa_states.SCP_A_InitialFixationReleaseTime_ms,	'aIFTrel',	-1.5,	1.5; ...
	lfp_tfa_states.SCP_A_TargetTouchTime_ms,			'aCTacq',	-1.5,	1.5; ...
	lfp_tfa_states.SCP_A_RewardTrainOnsetTime_TDT_ms,	'aREWon',	-1.5,	1.5; ...
	};
