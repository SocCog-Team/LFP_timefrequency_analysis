...
%lfp_tfa_cfg.results_folder = fullfile('C:', 'SCP_DATA', 'SCP_CTRL-01', 'RESULTS', 'LFP_TFA');
lfp_tfa_cfg.results_folder = fullfile('C:', 'SCP_DATA', 'SCP_CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir', 'TDT', 'lfp_lta', 'RESULTS', 'LFP_TFA');
...
if ~lfp_tfa_cfg.process_LFP
	...
	%lfp_tfa_cfg.proc_lfp_folder = ...
	%fullfile('C:', 'SCP_DATA', 'SCP_CTRL-01', 'RESULTS', 'LFP_TFA', 'A_Elmo_B_HumanConfederates_Test', 'processed_LFP');
	lfp_tfa_cfg.proc_lfp_folder = ...
		fullfile('C:', 'SCP_DATA', 'SCP_CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir', 'TDT', 'lfp_lta', 'RESULTS', 'LFP_TFA', 'A_Elmo_B_HumanConfederates_Test', 'processed_LFP');
end
...
if ~lfp_tfa_cfg.compute_site_average
	...
	%lfp_tfa_cfg.analyse_lfp_folder = ...
	%fullfile('C:', 'SCP_DATA', 'SCP_CTRL-01', 'RESULTS', 'LFP_TFA', 'A_Elmo_B_HumanConfederates_Test', 'analyzed_LFP');
	lfp_tfa_cfg.analyse_lfp_folder = ...
		fullfile('C:', 'SCP_DATA', 'SCP_CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir', 'TDT', 'lfp_lta', 'RESULTS', 'LFP_TFA', 'A_Elmo_B_HumanConfederates_Test', 'analyzed_LFP');
end
...
%lfp_tfa_cfg.info_filepath = fullfile('C:', 'SCP_DATA', 'SCP_CTRL-01', 'RESULTS', 'LFP_TFA', 'A_Elmo_B_HumanConfederates_Test', 'Elm_sorted_units.xls');
lfp_tfa_cfg.info_filepath = fullfile('C:', 'SCP_DATA', 'SCP_CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir', 'TDT', 'lfp_lta', 'Elm_sorted_units.xls');
...
%     struct('Monkey',        'Elmo', ...
%            'Date',          '20210219', ...
% 		   'Input',         'D:\SCP_DATA\SCP-CTRL-01\SESSIONLOGS\2021\210219\20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir\TDT\lfp_lta\sites_20210219T145809.A_Elmo.B_DL.SCP_01.mat', ...
%            'Preinj_blocks',  0, ...
%            'Postinj_blocks', 'all');
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile('D:', 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir', 'TDT', 'lfp_lta', 'sites_20210219T145809.A_Elmo.B_DL.SCP_01.mat'), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
