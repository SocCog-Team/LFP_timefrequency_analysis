...
lfp_tfa_cfg.root_dir = 'D:';
lfp_tfa_cfg.session_base_dir = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir');
lfp_tfa_cfg.session_base_dir = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '211006', '20211006T143535.A_Elmo.B_None.SCP_01.sessiondir');
lfp_tfa_cfg.session_base_dir = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210218', '20210218T131636.A_Elmo.B_FS.SCP_01.sessiondir');
lfp_tfa_cfg.root_dir = 'G:';
lfp_tfa_cfg.session_base_dir = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210201', '20210201T154108.A_Elmo.B_None.SCP_01.sessiondir');
lfp_tfa_cfg.session_base_dir = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210202', '20210202T154700.A_Elmo.B_DL.SCP_01.sessiondir');
lfp_tfa_cfg.session_base_dir = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210203', '20210203T151622.A_Elmo.B_DL.SCP_01.sessiondir');

lfp_tfa_cfg.root_dir = 'D:';
lfp_tfa_cfg.session_base_dir = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210326', '20210326T110743.A_Elmo.B_KN.SCP_01.sessiondir');
lfp_tfa_cfg.session_base_dir = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210316', '20210316T134225.A_Elmo.B_FS.SCP_01.sessiondir');
...
%lfp_tfa_cfg.results_folder = fullfile('C:', 'SCP_DATA', 'SCP-CTRL-01', 'RESULTS', 'LFP_TFA');
lfp_tfa_cfg.results_folder = fullfile(lfp_tfa_cfg.session_base_dir, 'TDT', 'lfp_tfa', 'RESULTS', 'LFP_TFA');
...
lfp_tfa_cfg.version = 'A_Elmo_B_HumanConfederates_v02';
...
%SM: the 'Processed LFP' final folder name is hard coded in lfp_tfa_define_settings.m,
%so stick to it.
...
if ~lfp_tfa_cfg.process_LFP
	...
	%lfp_tfa_cfg.proc_lfp_folder = ...
	%fullfile('C:', 'SCP_DATA', 'SCP-CTRL-01', 'RESULTS', 'LFP_TFA', 'A_Elmo_B_HumanConfederates_Test', 'processed_LFP');
	lfp_tfa_cfg.proc_lfp_folder = ...
		fullfile(lfp_tfa_cfg.session_base_dir, ...
		'TDT', 'lfp_tfa', 'RESULTS', 'LFP_TFA', lfp_tfa_cfg.version, 'Processed LFP');
end
...
%SM: the 'LFP Analysis' final folder name is hard coded in lfp_tfa_define_settings.m,

if ~lfp_tfa_cfg.compute_site_average
	%     lfp_tfa_cfg.analyse_lfp_folder = ...
	%         'Y:\Personal\Sarath\Results\LFP_TFA_Results\Linus_inactivation_8sessions\LFP Analysis';
	%lfp_tfa_cfg.analyse_lfp_folder = ...
	%fullfile('C:', 'SCP_DATA', 'SCP-CTRL-01', 'RESULTS', 'LFP_TFA', 'A_Elmo_B_HumanConfederates_Test', 'analyzed_LFP');
	lfp_tfa_cfg.analyse_lfp_folder = ...
		fullfile(lfp_tfa_cfg.session_base_dir,...
		'TDT', 'lfp_tfa', 'RESULTS', 'LFP_TFA', lfp_tfa_cfg.version, 'LFP Analysis');
end
...
%lfp_tfa_cfg.info_filepath = fullfile('C:', 'SCP_DATA', 'SCP-CTRL-01', 'RESULTS', 'LFP_TFA', 'A_Elmo_B_HumanConfederates_Test', 'Elm_sorted_units.xls');
lfp_tfa_cfg.info_filepath = fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210316', '20210316T134225.A_Elmo.B_FS.SCP_01.sessiondir',...
	'TDT', 'lfp_tfa', 'Elm_sorted_neurons.xls');
...
%     struct('Monkey',        'Elmo', ...
%            'Date',          '20210219', ...
% 		   'Input',         'D:\SCP_DATA\SCP-CTRL-01\SESSIONLOGS\2021\210219\20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir\TDT\lfp_tfa\sites_20210219T145809.A_Elmo.B_DL.SCP_01.mat', ...
%            'Preinj_blocks',  0, ...
%            'Postinj_blocks', 'all');
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210219', '20210219T145809.A_Elmo.B_DL.SCP_01.sessiondir',...
								'TDT', 'lfp_tfa', ['sites_', '20210219T145809.A_Elmo.B_DL.SCP_01.mat']), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
...
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '211006', '20211006T143535.A_Elmo.B_None.SCP_01.sessiondir',...
								'TDT', 'lfp_tfa', ['sites_', '20211006T143535.A_Elmo.B_None.SCP_01.mat']), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
...
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210218', '20210218T131636.A_Elmo.B_FS.SCP_01.sessiondir',...
								'TDT', 'lfp_tfa', ['sites_', '20210218T131636.A_Elmo.B_FS.SCP_01.mat']), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
...
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210201', '20210201T154108.A_Elmo.B_None.SCP_01.sessiondir',...
								'TDT', 'lfp_tfa', ['sites_', '20210201T154108.A_Elmo.B_None.SCP_01.mat']), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
...
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210202', '20210202T154700.A_Elmo.B_DL.SCP_01.sessiondir',...
								'TDT', 'lfp_tfa', ['sites_', '20210202T154700.A_Elmo.B_DL.SCP_01.mat']), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
...
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210203', '20210203T151622.A_Elmo.B_DL.SCP_01.sessiondir',...
								'TDT', 'lfp_tfa', ['sites_', '20210203T151622.A_Elmo.B_DL.SCP_01.mat']), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
...
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210326', '20210326T110743.A_Elmo.B_KN.SCP_01.sessiondir',...
								'TDT', 'lfp_tfa', ['sites_', '20210326T110743.A_Elmo.B_KN.SCP_01.mat']), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
...
lfp_tfa_cfg.session_info(1) = ...
	struct('Monkey',        'Elmo', ...
	'Date',          '20210219', ...
	'Input',         fullfile(lfp_tfa_cfg.root_dir, 'SCP_DATA', 'SCP-CTRL-01', 'SESSIONLOGS', '2021', '210316', '20210316T134225.A_Elmo.B_FS.SCP_01.sessiondir',...
								'TDT', 'lfp_tfa', ['sites_', '20210316T134225.A_Elmo.B_FS.SCP_01.mat']), ...
	'Preinj_blocks',  0, ...
	'Postinj_blocks', 'all');
...
lfp_tfa_cfg.compare.targets = {'A1_PMd_r', 'A2_PMd_r', 'A3_PMd_r', 'A4_PMd_r', 'A5_PMd_r'};
...
if any(strcmp(lfp_tfa_cfg.analyses, 'sync') | strcmp(lfp_tfa_cfg.analyses, 'syncsp'))
	...
	%        {'MIP_L', 'MIP_L'}};
	lfp_tfa_cfg.compare.target_pairs = {{'A1_PMd_r', 'A2_PMd_r'}};
end
...
% 4. Start time offset - offset in seconds from reference state onset for
% the start of time window
% start time = Reference state onset time + Start time offset
% 5. End time offset - offset in seconds from ref. state onset for end of
% time window
...
% 	'single', lfp_tfa_states.SCP_A_InitialFixationOnsetTime_ms,		'IFTon',	-0.2,	0.2;...
% 	'single', lfp_tfa_states.SCP_A_TargetOnsetTime_ms,				'CTon',		-0.2,	0.2; ...
...
% lfp_tfa_cfg.analyse_states = {...
% 	'single', lfp_tfa_states.SCP_A_TargetOnsetTime_ms,				'CTon',		-0.25,	0.5; ...
% 	'single', lfp_tfa_states.SCP_A_InitialFixationReleaseTime_ms,	'aIFTrel',	-0.75,	1.0; ...
% 	'single', lfp_tfa_states.SCP_B_InitialFixationReleaseTime_ms,	'bIFTrel',	-0.75,	1.0; ...
% 	};

lfp_tfa_cfg.analyse_states = {...
	...%'single', lfp_tfa_states.SCP_A_InitialFixationOnsetTime_ms,		'IFTon',	-0.5,	0.0;...
	'single', lfp_tfa_states.SCP_A_TargetOnsetTime_ms,				'CTon',		-0.5,	0.5; ...
	'single', lfp_tfa_states.SCP_A_InitialFixationReleaseTime_ms,	'aIFTrel',	-0.75,	1.0; ...
	};
...
lfp_tfa_cfg.analyse_epochs = {...
	lfp_tfa_states.SCP_A_InitialFixationOnsetTime_ms,	'IFTon',	-0.0,	0.20;...
	lfp_tfa_states.SCP_A_TargetOnsetTime_ms,			'CTon',		-0.0,	0.20; ...
	lfp_tfa_states.SCP_A_GoSignalTime_ms,				'aGOon',	-0.0,	0.20; ...
	lfp_tfa_states.SCP_A_InitialFixationReleaseTime_ms,	'aIFTrel',	-0.25,	0.25; ...
	lfp_tfa_states.SCP_A_TargetTouchTime_ms,			'aCTacq',	-0.25,	0.25; ...
	lfp_tfa_states.SCP_A_RewardTrainOnsetTime_TDT_ms,	'aREWon',	-0.0,	0.20; ...
	};
...
% 20220502sm: this got shifted from LR to CI
%	according to lfp_tfa_process_LFP.m left is mapped to 'I', right to 'C',
%	and 'N' for not assigned? But here target is _R, so left hand is C
lfp_tfa_cfg.compare.reach_hands = {'C'};
...
%lfp_tfa_cfg.compare.perturbations = NaN;	% 20220502sm: does not seem to work 
...
%     'choice', {0, 1}}};
lfp_tfa_cfg.diff_condition(1) = {{'type_eff', {[2 1], [5 1]}}};
...
lfp_tfa_cfg.mintrials_percondition = 10;
...
if strcmp(lfp_tfa_cfg.tfr.method, 'wavelet')
	...
	%    lfp_tfa_cfg.tfr.width       = 7; %??? should be odd?
end
...
%20220502sm: '' aka 'trial' does not work...
lfp_tfa_cfg.baseline_ref_state = 'SCP_A_InitialFixationOnsetTime_ms';

if ischar(lfp_tfa_cfg.baseline_ref_state)
	if isfield(lfp_tfa_states, lfp_tfa_cfg.baseline_ref_state)
		lfp_tfa_cfg.baseline_ref_state = lfp_tfa_states.(lfp_tfa_cfg.baseline_ref_state);
	end
end
...
if isempty(lfp_tfa_cfg.baseline_ref_state)
	...
	%20220502sm: 
	lfp_tfa_cfg.baseline_ref_period = [-0.5 0.0]; % SET LIMITS OF baseline_ref_period here
end
...
if length(lfp_tfa_cfg.compare.choice_trials) == 1
	...
	lfp_tfa_cfg.baseline_use_choice_trial = 1;
end
...
lfp_tfa_cfg.correction_method ='FDR'; % FDR or Bonferroni
...
% called in lfp_tfa_plot_site_evoked_LFP
